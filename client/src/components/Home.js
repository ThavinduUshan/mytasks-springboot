  ...
  return (
    <>
      ...
      <div className="mx-auto shadow-lg w-6/12 bg-gray-50 mb-10 px-16 py-10 rounded-lg">
        ...
        <h1 className="text-3xl font-medium mb-5 ">Task Name</h1>
        <p className="text-md mb-5">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nemo earum,
          assumenda in optio minima praesentium, accusamus provident at est
          error ipsum ducimus molestiae tempora laboriosam aut soluta magnam
          fuga voluptatum?
        </p>
        <div className="flex mb-5">
          ...
          <p className="mr-5 font-medium ">End Date : </p>
          <p className="font-medium">20-March-2022</p>
        </div>
        <div className="flex mb-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex justify-end">
          <button className="text-white text-lg rounded-lg px-5 py-3 bg-gray-800">
            Mark as Done
          </button>
        </div>
      </div>
